...
return [
    'modules' => [
        ...
        'CommerceExtensions_AddressType' => 1,
        'Facebook_BusinessExtension' => 1,
        'Magedelight_Base' => 1,
        'Magedelight_ScheduleShipping' => 1,
        ...
        'Softnoesis_Addtocartpopup' => 1,
        'Softnoesis_CategoryAttribute' => 1,
        'Softnoesis_RegistrationAttribute' => 1,
        'Softnoesis_Sitemapexclusion' => 1,
        'Softnoesis_WholesaleInquiry' => 1,
