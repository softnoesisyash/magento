...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Softnoesis_WholesaleInquiry::grid_list');
        // echo "hello";
        // die();
    ...
    {
        return $this->_authorization->isAllowed('Softnoesis_WholesaleInquiry::grid_list');
    }
}