<?php
namespace Softnoesis\RegistrationAttribute\Setup;
...
$customerSetup->addAttribute(Customer::ENTITY,'office_number',	[
...
$sampleAttribute = $customerSetup->getEavConfig()->getAttribute(Customer::ENTITY, 'office_number')
->addData(
[
