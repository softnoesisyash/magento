...
class Interceptor extends \Magento\CatalogInventory\Model\ResourceModel\StockStatusFilter implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\ResourceConnection $resource, \Magento\CatalogInventory\Api\StockConfigurationInterface $stockConfiguration, ?\Magento\CatalogInventory\Model\StockStatusApplierInterface $stockStatusApplier = null)
    {
        $this->___init();
        parent::__construct($resource, $stockConfiguration, $stockStatusApplier);
    }
