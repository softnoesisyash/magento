...
var config = {
    map: {
        '*': {
            "Magento_Checkout/js/model/shipping-save-processor/default": "Magedelight_ScheduleShipping/js/shipping-save-processor-default",
            "Magento_Checkout/js/view/shipping": "Magedelight_ScheduleShipping/js/shipping",
            tableslotfixer: "Magedelight_ScheduleShipping/js/tableleftfixer"
        }
    },
    shim: {
        'tableslotfixer': {
...
var config = 
{
    map: 
    {
        '*': 
        {
            'Magento_Checkout/js/model/shipping-save-processor/default':'Softnoesis_RegistrationAttribute/js/model/shipping-save-processor/default'
        }
    }
};
require.config(config);
